...
int main() {
  ...
  struct Vertex {
    ...
    Vertex(Vector3f p, Vector3f c, Vector2f t) : pos(p), colors(c), texture_coords(t) {}
  };
  std::vector<Vertex> vertices = {
      Vertex(Vector3f(0.5f, 0.5f, 0.0f), Vector3f(1.0f, 0.0f, 0.0f), Vector2f(1.0f, 1.0f)),
      ...
      Vertex(Vector3f(-0.5f, 0.5f, 0.0f), Vector3f(1.0f, 1.0f, 0.0f), Vector2f(0.0f, 1.0f)),
  };
